...
asn_TYPE_member_t asn_MBR_HeaderInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HeaderInfo, aid),
	...
	{ ATF_POINTER, 9, offsetof(struct HeaderInfo, generationTime),
	...
	{ ATF_POINTER, 8, offsetof(struct HeaderInfo, expiryTime),
	...
	{ ATF_POINTER, 7, offsetof(struct HeaderInfo, generationLocation),
	...
	{ ATF_POINTER, 6, offsetof(struct HeaderInfo, p2pcdLearningRequest),
	...
	{ ATF_POINTER, 5, offsetof(struct HeaderInfo, missingCrlIdentifier),
	...
	{ ATF_POINTER, 4, offsetof(struct HeaderInfo, encryptionKey),
	...
	{ ATF_POINTER, 3, offsetof(struct HeaderInfo, inlineP2pcdRequest),
	...
	{ ATF_POINTER, 2, offsetof(struct HeaderInfo, requestedCertificate),
	...
	{ ATF_POINTER, 1, offsetof(struct HeaderInfo, pduFunctionalType),
...
static const int asn_MAP_HeaderInfo_oms_1[] = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
