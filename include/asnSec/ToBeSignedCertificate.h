...
struct SequenceOfAidSsp;
struct SequenceOfAidGroupPermissions;
...
typedef struct ToBeSignedCertificate {
	...
	struct SequenceOfAidSsp	*appPermissions	/* OPTIONAL */;
	struct SequenceOfAidGroupPermissions	*certIssuePermissions	/* OPTIONAL */;
	struct SequenceOfAidGroupPermissions	*certRequestPermissions	/* OPTIONAL */;
